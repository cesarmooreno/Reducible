...
On my/our honor, Saif Ansari and Cesar Moreno, this
...
# print(hash_word("apple", 5))

# print(hash_word("banana", 5))
# print(hash_word("carrot", 5))
...
# #     """
    ...
    if (len(s) ==1) and (s in ["a","i", "o"]):
        ...
        for i in range(len(s)):
            #remove one letter at a time, see if that works
            new_string = s[:i] + s[i+1:]
            if is_reducible(new_string, hash_table, hash_memo):
                #insert s, not the string we were making
...
def main():
    ...
    for word in sorted(largest_reducible_words):
        print(word)
